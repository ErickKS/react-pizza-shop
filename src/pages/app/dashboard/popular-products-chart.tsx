...
import { getPopularProducts } from "@/api/get-popular-proucts";
            ...
            <PieChart style={{ fontSize: 12 }}>
              ...
              >
                {popularProducts.map((_, index) => (
                  <Cell key={`cell-${index}`} fill={COLORS[index]} className="stroke-background transition-all hover:opacity-80" />
                ))}
              </Pie>
            </PieChart>
          </ResponsiveContainer>
